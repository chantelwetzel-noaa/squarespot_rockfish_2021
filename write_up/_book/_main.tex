...
\hypersetup{
  pdftitle={Squarespot Rockfish (Sebastes hopkinsi) along the US West - California coast in 2020},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Squarespot Rockfish (\emph{Sebastes hopkinsi}) along the US West - California coast in 2020}
...
\noindent
\begin{center}
\title{Squarespot Rockfish (\emph{Sebastes hopkinsi}) along the US West - California coast in 2020}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Squarespot Rockfish (\emph{Sebastes hopkinsi}) along the US West - California coast in 2020}}
\vfill
by\\
...
This assessment reports the status of Squarespot Rockfish (\emph{Sebastes hopkinsi}) off the US West - California coast using data through xxxx.
