...
sens_wd = file.path(substr(mod_loc, 1, 51), "_sensitivities", "_plots")
nm = paste0(substr(mod_loc, 53, 99), "_compare2_spawnbio_uncertainty.png")
add_figure(
...
```{r, echo=FALSE, results='asis'}
nm = paste0(substr(mod_loc, 53, 99), "_compare4_Bratio_uncertainty.png")
add_figure(
filein = file.path(sens_wd, nm),
...
```{r, echo=FALSE, results='asis'}
nm = paste0(substr(mod_loc, 53, 99), "_compare12_recdevs_uncertainty.png")
add_figure(
filein = file.path(sens_wd, nm),
