...
caption = "Length composition data from the combined recreational and commercial fleet",
label = 'rec-com-len-data')
```

```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "comp_lendat_data_weighting_TA1.8_Comm_Rec.png"), 
caption = "Mean length for the combined recreational and commercial fleet with 95 percent confidence intervals",
...
```{r, results = 'asis'}
add_figure(
filein = file.path(data_fig_loc, "plots", "Mplots2021-03-26 09_05_49_Female.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(data_fig_loc, "plots", "Mdensityplots_FishLife_longevity.png"), 
