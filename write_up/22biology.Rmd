...
Maturity-at-length based on the work of Love et al [-@love_life_1990] which estimated the 50 percent size-at-maturity of `r round(model$MGparmAdj[,"Mat50%_Fem_GP_1"][1],2)` cm off the coast of California, however, the slope of the maturity curve was not estimated. In the absence of a literature value an intermediat slope of `r round(model$MGparmAdj$Mat_slope_Fem_GP_1[1], 2)` was assumed. Maturity was assumed to asymptote to 1.0 for larger fish (Figure \ref{fig:maturity}).  
