...
Squarespot rockfish are commonly found in waters between 60 - 119 meters in depth over rocky habitat {\tagstructbegin{tag=Reference}\tagmcbegin{tag=Reference}(Love 1996)\leavevmode\tagmcend\tagstructend}. Squarespot rockfish are yellow-brown, brown, or tan on the back and sides with lighter colored bellies. Squarespot rockfish is a dwarf species of rockfish with dimorphic growth between the sexes. Female squarespot rockfish reach larger sizes compared to males, with females reaching maximum sizes around 29 cm.
